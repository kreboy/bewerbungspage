...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password === $correctPassword) {
        ...
        header('Location: impressum.php'); // Seite neu laden, um geschützten Inhalt zu zeigen
        exit();
    } else {
...
if (!isset($_SESSION['authenticated']) || $_SESSION['authenticated'] !== true) {
    ...
    <head>
        <title>Passwortgeschützter Inhalt</title>
        <!-- Required meta tags -->
        <meta charset="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
        <meta name="description" content="Passwortschutz für geschützte Inhalte auf der Website von Ali Chaer." />
...
<html lang="en" data-bs-theme="dark">
    ...
    <body style="padding-bottom: 80px;">
        <header>
            <!-- place navbar here -->
             <nav
                class="navbar navbar-expand-sm navbar-dark bg-dark-subtle"
             >
                <div class="container">
                    <a class="navbar-brand" href="#"><i class="fa fa-code" aria-hidden="true" style="color:goldenrod"></i></a>
                    <button
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavId">
                        <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="https://github.com/Felix-From"><i class="fa fa-github" aria-hidden="true"></i> GitHub</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                >
                                    <a class="dropdown-item d-flex justify-content-between align-items-center" href="#"
                                        >SomeOtherStuff <div
                                        class="badge rounded-pill text-bg-primary ms-3"
                                        >New!</div
                                    ></a
                                    >
                                    <a class="dropdown-item d-flex justify-content-between align-items-center" href="#"
                                        >PokeEditor - Pokerogue <div
                                        class="badge rounded-pill text-bg-primary ms-3"
                                        >New!</div
                                    ></a
                                    >
        ...
        <main class = "">
            <div class="container impressum-box mt-5 p-5">
                <div class="row">
                    <div class="impressum">
                        <h1 id="kontakt">Kontaktinformationen</h1>
                        <address>
                        <strong>Max Mustermann</strong><br>
                        <abbr title="Telefonnummer">Tel.:</abbr> +49 123456789<br>
                    ...
                    <div class="impressum mt-5">
                        ...
                        dieser Website ist:</p> <p>Max Mustermann<br />
                        Am Musterweg 34<br />
                        79232 Musterstadt</p>
                        <p>Telefon: 0123456789<br />
                        E-Mail: Mustermann@web.de</p>
                    ...
                    <p class="text-muted">Quelle: <a href="https://www.e-recht24.de/impressum-generator.html">www.e-recht24.de</a></p>
                  </div>
            </div>        
        </main>
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 mt-5 border-top bg-dark-subtle fixed-bottom">
            <p class="col-md-4 mb-0 text-body-secondary">© 2024 Max Mustermann - <i class="fa fa-github" aria-hidden="true"></i> <a href="https://github.com/Felix-From">Coffee</a></p>
        
            <a href="#" class="col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none" data-bs-toggle="tooltip" data-bs-placement="top" title="It is inhumane, in my opinion, to force people who have a genuine medical need for coffee to wait in line behind people who apparently view it as some kind of recreational activity." >
                <i class="fa fa-coffee fa-2x" aria-hidden="true"></i>
            </a>
        
            <ul class="nav col-md-4 justify-content-end">
              <li class="nav-item"><a href="index.html" class="nav-link px-2 text-body-secondary">Home</a></li>
              <li class="nav-item"><a href="#/impressum.html" class="nav-link px-2 text-body-warning">Impressum</a></li>
            </ul>
          </footer>
